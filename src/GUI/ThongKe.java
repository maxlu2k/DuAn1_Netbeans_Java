...
//        getData();
    ...
    private void rdTatCaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdTatCaActionPerformed
        ...
        lbTuNgayNgay.setText("Từ Lúc Bắt Đầu");
...
//        System.out.println("theo thang");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (lbDoanhThu.getText().equals("0") && lbHoaDon.getText().equals("0") && lbHuy.getText().equals("0") && lbKhachHang.getText().equals("0") && lbSoLuong.getText().equals("0")) {
            JOptionPane.showMessageDialog(this, "Thống kê chưa có gì để báo cáo");
        } else {
            ...
            if (dialogButton == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    message.setFrom(new InternetAddress("dungndmph19187@fpt.edu.vn"));
                    message.setRecipients(
                            Message.RecipientType.TO,
                            InternetAddress.parse("manhdung6112000@gmail.com") //emaill nhận ,thangtqph17586@fpt.edu.vn
                    );
                    Date date = new Date();
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat();
                    ...
                    if (rdTatCa.isSelected()) {
                        message.setText("THỜI GIAN BÁO CÁO: " + format + "\n----------\n" + "\nThống kê từ trước đến hiến tại: " + format + doanhThu + sanPham + hoaDonThanhCong + hoaDonHuy + KhachHang);
                    } else {
                        batDau = "\nTừ ngày: " + batDau1;
                        ketThuc = "\nĐến ngày: " + ketThuc1;
    ...
    private void btnLocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocActionPerformed
        ...
        if (rdTatCa.isSelected()) {
            ...
            if (DateBatDau.getDate() == null || DateKetThuc.getDate() == null) {
                JOptionPane.showMessageDialog(this, "Không được để trống NGÀY CHỌN");
