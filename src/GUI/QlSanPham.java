...
public class QlSanPham extends javax.swing.JPanel {
    ...
    private void tblSanPham1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham1MouseReleased
        if (evt.isPopupTrigger()) {
            ...
            jMenuItem3.setText("Xóa sản phẩm khỏi danh mục");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        int chon = JOptionPane.showConfirmDialog(this, "bạn có chắc chăn muốn xóa?", "Thông báo", JOptionPane.YES_NO_OPTION, WIDTH);
        if (chon == 0) {
            sanPham_Dao.Delete(dtmSanPham1.getValueAt(index, 0).toString());
            LoadTable();
            loadTable1();
        }
